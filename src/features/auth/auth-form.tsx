        ...
        <div className="grid w-full overflow-hidden rounded-[34px] border border-[#E4E7EF] bg-white shadow-[0_30px_120px_rgba(23,26,43,0.09)] lg:grid-cols-[1fr_440px]">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8" autoComplete="on">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold tracking-[-0.03em] text-text-primary">{mode === "login" ? "Welcome back" : "Create account"}</h2>
            ...
            {mode === "login" ? (
              <label className="mt-4 flex cursor-pointer items-center gap-3 rounded-2xl border border-[#E4E7EF] bg-white px-4 py-3 text-sm text-text-primary transition hover:bg-[#F7F8FC]">
                <input
                  type="checkbox"
            ...
            <div className="mt-5 flex flex-col gap-3 text-sm sm:flex-row sm:items-center sm:justify-between">
              ...
              <button type="button" className="w-fit text-[#6D7285] hover:text-text-primary disabled:cursor-not-allowed disabled:opacity-50" disabled={isResetting} onClick={handlePasswordReset}>
